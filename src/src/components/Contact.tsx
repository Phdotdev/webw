...
${formData.phone ? `Telefone: ${formData.phone}` : ''}`;
    ...
    const whatsappUrl = `https://wa.me/5591993190904?text=${encodeURIComponent(whatsappMessage)}`;
    window.open(whatsappUrl, '_blank');
  };

  return (
    <section id="contato" className="py-20 bg-primary-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Pronto para começar seu projeto? Fale comigo agora mesmo!
          </p>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-300 text-lg mb-8">
                Atendo 100% remotamente em todo o Brasil. Entre em contato através dos canais abaixo e receba seu orçamento personalizado.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-gray-300">(91) 9 9319-0904</p>
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-gray-300">pedrohcm8@icloud.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-gray-300">@ph_ftth</p>
          ...
          <div className="bg-primary-950 rounded-2xl shadow-lg p-8 border border-gold-400/20">
            ...
            <div className="mt-6 p-4 bg-primary-900/50 rounded-lg border border-gold-400/20">
              <p className="text-sm text-gray-300 text-center">
                Ao enviar, sua mensagem será direcionada para o WhatsApp para um atendimento mais rápido e personalizado.
              </p>
            </div>
          </div>
        </div>
