    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto animate-slide-up delay-200">
          com agilidade e precisão. Seu projeto começa aqui.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 animate-slide-up delay-600">
          <div className="text-center">
            ...
            <div className="text-gray-300">Remoto</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gold-400 mb-2">✓</div>
            <div className="text-gray-300">Praticidade e Velocidade</div>
          </div>
        </div>
      </div>
    </section>
