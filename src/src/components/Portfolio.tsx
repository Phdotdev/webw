        ...
        <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-2xl p-8 md:p-12 border border-gold-400/20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="w-full h-32 bg-gradient-to-br from-primary-900 to-primary-800 rounded-lg mb-4 flex items-center justify-center border border-gold-400/30">
